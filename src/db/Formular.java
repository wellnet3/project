...
public class Formular {
    ...
    private static String path1 = "C:\\Users\\User\\Desktop\\Vorlage Rechnung Praxis1.dotm";
    private static String path2 = "C:\\Users\\User\\Desktop\\Vorlage Rechnung Privat1.dotm";
    private static String path3 = "C:\\Users\\User\\Desktop\\docx\\";
	...
	FileOutputStream out = new FileOutputStream(new File(path3 + dateiname + ".docx"));
	docx.write(out);
	docx.close();
	out.close();
    }
	...
	PdfConverter.getInstance().convert(doc, new FileOutputStream(new File(path3 + dateiname + ".pdf")), PdfOptions.getDefault());
    }
    
    public static void setPath(String path) {
	path1 = path + "Vorlagen\\Vorlage Rechnung Praxis1.dotm";
	path2 = path + "Vorlagen\\Vorlage Rechnung Privat1.dotm";
	path3 = path + "docx\\";
    }
